        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md lg:ml-auto w-full relative z-10">
              ...
              >
                {t("footer.subscribe")} <Send size={18} />
              </button>
            </form>
          </div>
        </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold">{t("footer.headquarters")}</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold">{t("footer.emailUs")}</p>
                  <a
                    href="mailto:info@zendo.com"
                    dir="ltr"
                    className="text-gray-600 text-sm hover:underline hover:text-[#bce201] transition-colors inline-block"
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold">{t("footer.callSupport")}</p>
                  <a
