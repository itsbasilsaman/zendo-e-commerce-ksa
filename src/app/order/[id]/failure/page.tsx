        ...
        <div className="min-h-screen bg-white text-black font-sans border-t-2 border-black selection:bg-[#bce201] selection:text-black relative">
            ...
            <main className="container mx-auto px-4 md:px-6 py-8 md:py-12 max-w-4xl relative z-10">
                ...
                <motion.div
                    ...
                    className="bg-red-400 border-2 border-black rounded-xl p-6 md:p-8 shadow-[6px_6px_0px_0px_#000] mb-8 flex flex-col sm:flex-row items-center gap-4"
                >
                    ...
                    <div>
                        ...
                        <p className="font-bold text-white/80 mt-1">
                            Something went wrong with your payment. Please retry or contact support.
                        </p>
                        {id && (
                            <p className="text-xs font-mono font-bold bg-white/20 rounded px-2 py-0.5 mt-2 inline-block text-white">
                                Order ID: {id}
                            </p>
                        )}
                    </div>
